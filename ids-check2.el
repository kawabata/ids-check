...
(defconst ids-check2-idc-check
  `((?⿴
    ...
    (?⿸
     ,(concat
       "朩⺶㞑䧹丂丆严丰丿亣产十千升卩厂厃原厤厥厭厲声子尔尸尹尾局屁屵广庚府庳庶廆廌廣廱彥彦戶户戸曆最歹灰牛申疒病痲痺睂耂耳聿薦虍虎虚虛豸辰辱雁靡鴈鹿麃麻龵𠀆𠁣𠂆𠂇𠂋𠂟𠃋𠃜𠇭𠩵𠩺𡰤𢀩𢑚𢨳𤕫𥆞𨿳痳𤸰𢈙𡾷厌㾜庫𢉖"
     "⑥⑨⿻廾厚𢊆夕牙" ; ext-f
       ))
    (?⿹
     ,(concat
...
(defconst ids-check2-dc-check-chars
  `((left
     "彳亻扌氵丬犭牜礻糹纟衤讠𧾷钅飠𩙿饣忄歹歺𤴔爿𫯂")
    (right
     "亍刂")
    (top
     ,(concat "癶丷宀𠆢艹艹爫㓁𦍌覀𠔉龹罒亠⺊𦉰𦍌竹𦘒𠭃"
              ""))
    (bottom
     "龰灬㣺朩氺𧘇𫶧𣥂")
    (not-left
